...
**Objetivo:** revisar el historial de los últimos 5 comandos, filtrar el contenido para mostrar solo la ejecución de `touch`, luego eliminar el historial de comandos y mostrar el historial actual.
